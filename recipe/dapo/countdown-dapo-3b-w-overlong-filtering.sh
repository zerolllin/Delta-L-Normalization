...
exp_name='countdown-dapo-3b-w-overlong-filtering'
...
enable_filter_overlong=True ## new setting
...
ray job submit --no-wait --runtime-env="${RUNTIME_ENV}" \
    ...
    algorithm.filter_overlong_response.enable=${enable_filter_overlong} \
