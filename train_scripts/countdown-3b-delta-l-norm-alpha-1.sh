pushd $(dirname "$0") > /dev/null
    ...
    export DATA_DIR=~/data/countdown_nochat
    export ROLLOUT_TP_SIZE=1
    export EXPERIMENT_NAME=countdown-3b-delta-l-norm-alpha-1
    ...
    python3 -m verl.trainer.main_ppo \
        ...
        actor_rollout_ref.rollout.max_num_batched_tokens=8448 \
        ...
        algorithm.grpopp_config.alpha=1 \
        actor_rollout_ref.actor.use_grpopp=True \
        actor_rollout_ref.actor.grpopp_config.alpha=1
